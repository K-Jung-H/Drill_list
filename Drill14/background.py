...
class FixedBackground:
    ...
    def __init__(self):
        ...
        # fill here
        self.cw = get_canvas_width() # 현재 화면의 너비
        self.ch = get_canvas_height() # 현재 화면의 높이
        self.w = self.image.w
        self.h = self.image.h
    ...
    def update(self):
        ...
        self.window_left = clamp(0, self.window_left, self.w - self.cw -1) # -1 꼭 해줘야 함
        self.window_bottom = clamp(0, self.window_bottom, self.h - self.ch -1) # -1 꼭 해줘야 함
        pass
